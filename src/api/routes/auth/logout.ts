...
export const logout = async (req: Request): Promise<Response> => {
    ...
    try {
      ...
      const credentials = await getModule().userRepository.getUserCredentialsByUid(userUid);
      ...
      return makeErrorResponse(500, "An unexpected error occurred while logging out");
    }
  };
