	...
	const features = [
		{
			...
			description:
				"Industry-leading security protocols ensure your crypto assets stay safe.",
			...
			<div className="bg-white py-20">
				<div className="max-w-6xl mx-auto px-6">
					<div className="text-center mb-12">
						...
						>
							We prioritize security and transparency above all, ensuring your
							crypto investments are in safe hands.
						</motion.p>
					</div>
					...
					>
						...
						<div className="relative z-10">
							...
							<p className="text-xl text-gray-600 italic mb-6">
								"BitSlowShop provides the perfect balance between security and
								usability. I've never felt safer making crypto transactions, and
								their customer support is unmatched in the industry."
							</p>
