      ...
      <div className="max-w-2xl w-full bg-white backdrop-blur-lg bg-opacity-95 p-8 rounded-2xl shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-center mb-6">
            <div className="flex items-center w-full max-w-sm">
              <div className={`flex flex-col items-center ${step >= 1 ? 'text-blue-600' : 'text-gray-400'}`}>
                <div className={`rounded-full flex items-center justify-center w-8 h-8 ${step >= 1 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-500'}`}>
              ...
              <div className={`flex flex-col items-center ${step >= 2 ? 'text-blue-600' : 'text-gray-400'}`}>
                <div className={`rounded-full flex items-center justify-center w-8 h-8 ${step >= 2 ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-500'}`}>
                  2
                </div>
          ...
          <p className="text-gray-500 text-sm text-center mb-6">
            {step === 1 ? "Join BitSlowShop and start trading crypto" : "Tell us more about yourself"}
          </p>
          ...
          {step === 1 ? (
            <form onSubmit={handleStep1Submit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500 pl-2">Password must be at least 8 characters long</p>
              </div>
            ...
            <form onSubmit={handleStep2Submit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="phonePrefix" className="text-sm font-medium flex items-center">
                ...
                <div className="space-y-2 col-span-1 md:col-span-2">
                  ...
                  <div className="relative">
                    <Textarea
                      ...
                      rows={3}
                    />
                    <Home size={18} className="absolute left-3 top-2.5 text-gray-400" />
                  </div>
                </div>
              </div>
          ...
          <div className="mt-6 p-3 bg-blue-50 border border-blue-100 rounded-lg">
            <div className="flex items-start">
              ...
              <p className="text-blue-700 text-xs">
                BitSlowShop follows strict KYC (Know Your Customer) regulations. Your information is securely encrypted and only used for verification purposes.
              </p>
            </div>
          </div>
